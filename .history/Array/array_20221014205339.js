...
const arr = [1,2,3,4,5];
//arr.push.apply(arr, [6,7,8,9,0]);
arr.push(... [6,7,8,9,10]);
let newArray = [ ... arr, ... [11,12,13,14,15]]
console.log(arr)
...
arr.push.apply(arr, [6, 7, 8, 9, 10]);
console.log(arr);
arr.push(...[6, 7, 8, 9, 10]);
console.log(arr);

//Removing duplicates data from the array using spread operator
const uniqueArr = [...new Set(arr)];
console.log(uniqueArr);

//Connect multiple arrays
let newArr = [...uniqueArr, ...[11, 12, 13, 14, 15]];
console.log(newArr);

//Copying new into new Array using spread operators
let copyArr = [...newArr];
console.log(copyArr);

//Copying new into new Array normally
let copyArr2 = copyArr;
console.log(copyArr2);

//Destructure array:
const [num0, ...others] = copyArr;
console.log(num0);
console.log(others);

// Convert NodeList to a real Object
const obj = {
  name: "khalid",
  age: 22,
  country: "Bangladesh",
...
// Converting
const myName_array = [...myName];
console.log(myName_array);
// const strName = myName_array.toString();
// console.log(strName)
...
const arrToString = [...["khalid"], middleName, lastName];
arrToString;
...
console.log(
  Array.isArray(divs) ? "Hello World!" : false,
  Array.isArray(arrayDivs) ? "It's True" : "false"
);
